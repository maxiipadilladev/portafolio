                ...
                <div className="bg-dark-light/60 backdrop-blur-xl border border-primary/20 rounded-2xl p-8 md:p-12 shadow-2xl">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        ...
                        <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-full sm:w-auto px-8 py-4 rounded-full border-2 border-primary text-white font-bold text-lg hover:bg-primary/20 transition-all flex items-center justify-center gap-2"
                        >
                            <span>📅</span>
                            Book a Call
                        </a>
                    ...
                    <div className="mt-8 pt-6 border-t border-white/5">
                         <a href="mailto:contact@runatech.dev" className="text-primary hover:text-white transition-colors">
                            or email me at contact@runatech.dev
                         </a>
                    </div>
                </div>
            </div>
